Describe "Find-WordOverlap integrated temporal guard on real-audio jitter" {
    . "$PSScriptRoot/../src/Alignment/Find-WordOverlap.ps1"

    It "rejects the real-audio I-through-84 overlap when the current anchor starts earlier" {
        $previousWords = @(
