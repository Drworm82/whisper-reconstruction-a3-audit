...
Write-Host "Available functions: Build-WhisperWords, Find-WordOverlap, Reconstruct-WhisperWindows, Convert-WhisperX, New-WhisperWindows, Invoke-WhisperReconstruction"
